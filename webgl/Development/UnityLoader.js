...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 20516658;
      var PACKAGE_UUID = 'ace034ff-c12a-4355-9c38-c8db6a81531d';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 16686623, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(16686623, 16686644, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(16686644, 16686691, 0, 0).open('GET', '/PlayerConnectionConfigFile');
    new DataRequest(16686691, 16699325, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(16699325, 18992973, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(18992973, 20489033, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(20489033, 20516658, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
