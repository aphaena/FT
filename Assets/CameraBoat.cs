...
public class CameraBoat : MonoBehaviour {
    ...
    */
    ...
    public float m_camStartRotationY = 30.0f;

    public float m_camStartDistance = 60.0f;
    ...
    void Start () {
        ...
        m_previousPos = Ship.transform.position;
         ...
         /*
        transform.position = CamTargett.transform.position + new Vector3(XDecal, YDecal, ZDecal);
        transform.rotation = Quaternion.Euler(new Vector3(XRotat, YRotat, ZRotat));
    ...
    void LateUpdate()
    {
        ...
        {
            // m_position.camDistance = m_position.camDistance + 4.1f;
            m_target.camDistance *= amount;
            Debug.Log("camDistance:" + m_position.camDistance.ToString());
        }
    ...
    void ProcessInput()
    {
        ...
        amount = Mathf.Pow(1.02f, Mathf.Min(dt, 1.0f));
